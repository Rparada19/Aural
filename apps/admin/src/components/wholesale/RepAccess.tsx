    ...
    return (
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={busy}
          className="text-[var(--ink-soft)] text-xs hover:wsale-bad disabled:opacity-50 whitespace-nowrap"
        >
          Quitar acceso
        </button>
      </div>
      ...
      {mode === 'link' && (
        <div className="space-y-3">
          <Field label="Usuario existente">
            <select value={pick} onChange={(e) => setPick(e.target.value)} className="wsale-input">
